    ...
    <>
      <TerminalHeader
        ...
        statusItems={[
          ...
          { label: "Validation", value: validation.status ?? "unknown", tone: validation.status === "completed" ? "positive" : "info" },
      ...
      <section className="terminal-command-grid">
        <MetricCard label="Predictions" value={validation.predictions_generated ?? 0} subvalue="Generated by Learning Loop" icon={<Brain size={15} />} tone="info" />
        <MetricCard label="Outcomes" value={validation.outcomes_evaluated ?? 0} subvalue="Evaluated against reality" icon={<SearchCheck size={15} />} tone="positive" />
        <MetricCard label="Mistakes" value={validation.mistakes_analyzed ?? 0} subvalue="Classified for learning" icon={<XCircle size={15} />} tone="attention" />
        <MetricCard label="Memory Updates" value={validation.memory_updates ?? 0} subvalue="Knowledge written as data" icon={<Activity size={15} />} tone="positive" />
      </section>

      <section className="grid-2">
        <BloombergPanel title="Current Experiment" value={data.current_experiment?.status ?? "waiting"} subtitle="What BLUM is studying now">
