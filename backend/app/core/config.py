...
class Settings(BaseSettings):
    ...
    market_refresh_max_items_per_job: int = Field(default=20, alias="BLUM_MARKET_REFRESH_MAX_ITEMS_PER_JOB")
    ...
    strategy_factory_max_variants_per_family: int = Field(default=4, alias="BLUM_STRATEGY_FACTORY_MAX_VARIANTS_PER_FAMILY")
