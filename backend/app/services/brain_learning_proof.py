...
from app.models import BlumTradingPowerScore, LearningRun, LiveForwardPaperGame, LiveForwardPaperTrade
...
class BrainLearningProofService:
    ...
    def snapshot(self, db: Session) -> dict:
        return {
            ...
            "copy_readiness": _copy_readiness_proof(CopyReadinessSummaryService().summary(db)),
        }
